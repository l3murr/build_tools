...
RUN mkdir -p /etc/apt/keyrings && \
    ...
    apt-get update && \
    apt-get install -y nodejs git unzip net-tools locales supervisor clang mysql-client libz-dev libssl-dev libmysqlclient-dev protobuf-compiler pkg-config cmake nginx zsh zsh-autosuggestions zsh-syntax-highlighting vim && \
